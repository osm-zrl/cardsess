...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare the SQL query to update the student's information based on cef
    $sql_update = "UPDATE student SET first_name = ?, last_name = ?, birthday = ?, gender = ?, class_id = ? WHERE cef = ?";
    $stmt = $conn->prepare($sql_update);
    $stmt->bind_param("ssssss", $firstName, $lastName, $birthday, $gender, $classId, $id);

    // Execute the SQL query to update the student's information
    if (!$stmt->execute()) {
        echo "Error: " . $stmt->error;
    } else {
        // Redirect to the page to view all students
...
<body>
      ...
      <tbody>
        <?php
                ...
                while ($student = $result_students->fetch_assoc()) {
                    ...
                    echo'<td><a href="#" onclick="toggleEditStudent()"><i class="fa-solid fa-pen-to-square" id="icontable"></i></a></td>';
                    echo '<td><a href="students.php?cef=' . $student["cef"] . '" onclick="return confirmdelete()"><i class="fa-solid fa-trash" id="icontable"></i></a></td>'; 
                    echo "</tr>";            
                }
                ?>
      </tbody>
  ...
  <div class="information">
    <div class="cef">
      ...
      <input type="number" id="cef" name="cef" placeholder="Enter CEF" required>
    </div>
    <div class="fullname">
      <label for="edit-firstname">First Name:</label>
      <input type="text" id="edit-firstname" name="editfirstname" placeholder="Enter First Name" required>
      <label for="edit-lastname">Last Name:</label>
      <input type="text" id="edit-lastname" name="editlastname" placeholder="Enter Last Name" required>
    </div>
    <div class="birthgen">
      <label for="edit-birthday">Date of Birth:</label>
      <input type="date" id="edit-birthday" name="editbirthday" required>
      <label for="edit-gender">Gender:</label>
      <select id="edit-gender" name="editgender" required>
    ...
    <div class="classe">
      <label for="edit-classe">Student Group:</label>
      <select id="edit-classe" name="editclasse" required>
